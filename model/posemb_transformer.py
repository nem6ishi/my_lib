...
import module.posemb_transformer
...
class TransformerModel(torch.nn.Module):
  def __init__(self, setting, src_lang, tgt_lang):
    ...
    self.encoder = module.posemb_transformer.TransformerEncoder(src_lang.vocab_size,
    ...
    self.decoder = module.posemb_transformer.TransformerDecoder(tgt_lang.vocab_size,
    ...
    self.generator = module.posemb_transformer.TransformerGenerator(tgt_lang.vocab_size,
                                                             setting["decoder_vars"]["model_dim"])
  ...
  def translate(self, batch, max_length, beam_size=1, topk_greedy=3, reverse_output=False):
    outputs = self.encoder(batch.src_batch.sentences)
